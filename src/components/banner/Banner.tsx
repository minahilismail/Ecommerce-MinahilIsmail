  ...
  return (
    <div className="relative md:mx-6 lg:mx-[64px]">
      ...
      <div className="absolute md:top-[91px] md:bottom-[63px] md:left-[400px] md:right-[100px] lg:top-[91px] lg:bottom-[63px] lg:left-[797px] lg:right-[149px] top-[91px] bottom-[30px] left-[150px] right-[149px] flex items-center justify-center flex-col gap-[36px]">
        <button className=" flex items-center justify-center px-6 py-4 border border-transparent text-sm font-medium rounded-[20px] shadow-sm text-white bg-primary hover:bg-brandOrange focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500 h-[45px] w-[134px]">
          New Laptop
        </button>
