  ...
  return (
    <div className="relative md:mx-6 lg:ml-[64px] lg:mr-[61px]">
      <img
        ...
        alt="banner"
      />
      <div className="absolute md:top-[91px] md:bottom-[63px] md:left-[400px] md:right-[100px] lg:top-[91px] lg:bottom-[63px] lg:left-[797px] lg:right-[149px] top-[91px] bottom-[30px] left-[150px] right-[149px] flex items-center justify-center flex-col gap-[12px] md:gap-[36px]">
