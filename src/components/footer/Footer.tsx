...
const Footer: React.FC = () => {
  return (
    <div className="bg-quality px-[60px] w-full pt-[29px] md:pb-[42px] md:pt-[42px] mt-[60px]">
      <div className="bg-white md:py-[38px] py-[14px] px-[95.5px] rounded-[20px] flex flex-col md:flex-row items-center md:justify-between justify-center gap-[12px] lg:gap-[137px] mb-[41px]">
      ...
      <div className="flex flex-col md:flex-row justify-between gap-[25px] lg:gap-[80px] md:gap-0">
