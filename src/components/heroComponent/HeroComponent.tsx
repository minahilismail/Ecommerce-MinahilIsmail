...
const Home: React.FC = () => {
  return (
    <div className="xxl:pl-[174px] xxl:mx-0 lg:pl-[80px] xxl:pr-[146px] lg:pr-[50px] md:pr-[100px] flex flex-col-reverse md:flex-row items-center justify-center md:justify-normal lg:justify-between md:gap-[145px] xxl:gap-[449px]  bg-white sm:rounded-lg mt-[42px] md:mt-[38px] ml-[35px] mr-[23.76px] xxs:mx-6 ">
      ...
      <div className="flex items-center justify-center ">
        <div className="flex items-center">
          <div className="relative flex-shrink-0 items-center justify-center">
            <img
              className="h-[311px] w-[289.16px] sm:h-[300px] sm:w-[270.16px] lg:h-[335px] lg:w-[345px] xxl:h-[356px] xxl:w-[331px] md:h-[310px] md:w-[290px] items-center object-contain"
              src={cannonCamera}
              alt="Canon camera"
            />
