      ...
      <div className="bg-navColor w-full top-[74px] sticky md:px-[67.79px] md:py-[21px] px-[20.79px] py-[16px]">
          ...
          <div className="flex justify-between items-center gap-[24px]">
            <div className="flex lg:gap-[85px] items-center">
              ...
              <div className="hidden lg:flex container items-center justify-between bg-white w-[438px] h-[56px] py-[17.5px] pr-0 pl-[25px] gap-[10px] rounded-[20px]">
                <div>Search anything</div>
                <div className="container cursor-pointer py-[17.5px] px-[41px] bg-primary w-[132px] h-[56px] rounded-[20px] text-white flex items-center justify-center">
                  Search
                </div>
              </div>
            </div>
